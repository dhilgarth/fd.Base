...
{
    /// <summary>Contains extensions to the <see cref="System.String" /> class.</summary>
    public static class StringExtensions
    {
        /// <summary>Determines whether the end of the specified string matches any of the specified values.</summary>
        ...
        /// <summary>Changes a Pascal Case string to an All Upper Case string.</summary>
        /// <remarks>Existing underscores are not interpreted, i.e. Pascal_Case will yield PASCAL__CASE.</remarks>
        /// <example>PascalCase will yield PASCAL_CASE</example>
        /// <example>camelCase will yield CAMEL_CASE</example>
        /// <example>Street2 will yield STREET_2</example>
        /// <example>House2number will yield HOUSE_2NUMBER</example>
        /// <example>Crc32 will yield CRC_32</example>
