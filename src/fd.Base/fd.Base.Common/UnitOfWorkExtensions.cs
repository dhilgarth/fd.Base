...
{
    /// <summary>
    /// Holds extension methods for <see cref="IUnitOfWork"/> and <see cref="IUnitOfWorkFactory"/>.
    /// </summary>
    public static class UnitOfWorkExtensions
    {
        /// <summary>
        /// Executes the specified delegate on a new unit of work that is obtained from the <paramref name="unitOfWorkFactory"/>.
        /// </summary>
