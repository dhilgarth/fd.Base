...
{
    /// <summary>Represents a positive percentage value in the wider sense. 100% = 1.0.</summary>
    public class PositivePercentage : Constrained<double>
    {
        /// <summary>Initializes a new instance of the <see cref="PositivePercentage" /> class.</summary>
