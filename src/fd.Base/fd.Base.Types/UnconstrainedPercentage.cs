...
{
    /// <summary>Represents a percentage value in the wider sense. 100% = 1.0.</summary>
    public class UnconstrainedPercentage : Constrained<double>
    {
        /// <summary>Initializes a new instance of the <see cref="UnconstrainedPercentage" /> class.</summary>
