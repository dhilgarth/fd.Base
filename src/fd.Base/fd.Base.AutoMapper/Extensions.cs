...
{
    /// <summary>Contains extension methods in the context of the AutoMapper.</summary>
    public static class Extensions
    {
        /// <summary>Creates a simple two way map, i.e. it creates a map from <typeparamref name="T1" /> to <typeparamref name="T2" /> and vice versa.</summary>
