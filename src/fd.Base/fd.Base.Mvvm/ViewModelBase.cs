...
{
    /// <summary>The base class for all ViewModels.</summary>
    public abstract class ViewModelBase : GalaSoft.MvvmLight.ViewModelBase
    {
        /// <summary>Raises the <see cref="System.ComponentModel.INotifyPropertyChanged.PropertyChanged" /> event for the specified property.</summary>
        ...
        /// <summary>
        /// Sets the value of and raises the <see cref="System.ComponentModel.INotifyPropertyChanged.PropertyChanged" /> event for the specified property.
        /// </summary>
        /// <typeparam name="TProperty">The type of the property for which the event should be raised.</typeparam>
        /// <param name="propertyExpression">The expression that contains the name of the property for which the event should be raised.</param>
